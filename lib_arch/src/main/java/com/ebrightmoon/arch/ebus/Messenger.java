package com.ebrightmoon.arch.ebus;




import com.ebrightmoon.arch.command.BindingAction;
import com.ebrightmoon.arch.command.BindingConsumer;
...
/**
 * Messenger是一个轻量级全局的消息通信工具，在我们的复杂业务中，难免会出现一些交叉的业务，
 * 比如ViewModel与ViewModel之间需要有数据交换，这时候可以轻松地使用Messenger发送一个实体或一个空消息，
