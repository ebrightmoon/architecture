...
import com.ebrightmoon.utils.LogUtils;
...
public class LoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (request.body() == null) {
            LogUtils.e(String.format("Sending request %s on %s%n%s%n%s",
        ...
        LogUtils.e(String.format("Received Data: [%s] %njson:%s %n耗时: %.1fms%n%s",
