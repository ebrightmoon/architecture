package com.ebrightmoon.network.source.http;

import com.ebrightmoon.network.ResponseResult;
import com.ebrightmoon.network.source.HttpDataSource;
import com.ebrightmoon.network.source.entity.DemoEntity;
import com.ebrightmoon.network.source.http.service.DemoApiService;
...
public class HttpDataSourceImpl implements HttpDataSource {
    ...
    @Override
    public Observable<ResponseResult<DemoEntity>> demoGet() {
        return apiService.demoGet();
    }

    @Override
    public Observable<ResponseResult<DemoEntity>> demoPost(String catalog) {
